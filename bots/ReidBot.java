 ...
 *
 * @author sam.scott & Greg Reid
 * @version 1.1 (Aug 14, 2024)
 */
public class ReidBot extends Bot {
	...
	public int getMove(BotInfo me, boolean shotOK, BotInfo[] liveBots,
		...
		else if (me.getX() >= BattleBotArena.RIGHT_EDGE-Bot.RADIUS*2) {
			move = BattleBotArena.LEFT;
		}
	...
	{
		if (name == null)
			name = this.getClass().getSimpleName()+(botNumber<10?"0":"")+botNumber;
		return name;
	}
	...
	{
		String[] images = {"Pinwheel.png","Pinwheel.png","Pinwheel.png","Pinwheel.png"};
		return images;
	}
