...
public class BattleBotArena extends JPanel implements MouseListener, MouseWheelListener, MouseMotionListener, ActionListener, Runnable {
	 ...
	 * survival points 
	 */
	public static final double 	POINTS_PER_SECOND = 0.08; //ROWBOTTOM 082023 increased to 0.8 reward dodging ROWBOTTOM changed from 0.1 to discourage camping
	/**
	 ...
	 */
	public static final double 	BOT_SPEED = 4;//Math.floor(RIGHT_EDGE/400);//ROWBOTTTOM changed from 3 to accomodate larger screensROWBOTTOM changed from 2.5 to fix game balance and bots getting hung up on tombstones
	/**
	 * Bullet speed in pixels/frame
	 */
	public static final double 	BULLET_SPEED = 10;//Math.floor(RIGHT_EDGE/400);//ROWBOTTTOM changed from 6 to accomodate larger screens
	/**
